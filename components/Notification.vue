<template>
    <div class="fixed bottom-4 left-4 transition text-white px-5 pr-16 py-4 cursor-pointer z-50"
        ...
        <div class="flex items-center space-x-2">
          ...
          <font-awesome-icon icon="close" @click="closeNotification(false)"
            class="p-2 w-7 text-gray-300 close-btn hover:bg-gray-200 hover:bg-opacity-70 cursor-pointer 
